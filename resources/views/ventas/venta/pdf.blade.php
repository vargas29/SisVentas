...
<body>
	...
	<fieldset style="width: 660px; border-radius: 4%;">
		...
		<tr>
			 <td> <label for="proveedor">Cliente : </label></td><td style="border: 1px;"><p>{{$venta->nombre}}</p></td>
			 <td><label for="tipo_comprobante">Tipo Comprobrante :</label></td><td style="border: 1px;"><p>{{$venta->tipo_comprobante}}</p></td>
		 </tr>

		 <tr>
		 	<td><label for="serie_comprobante">Serie de Comprobante : </label></td><td  style="border: 1px;"><p>{{$venta->serie_comprobante}}</p></td>
		 	<td><label for="num_comprobante">Numero Comprobante</label></td><td style="border: 1px;"><p>{{$venta->num_comprobante}}</p></td>
		 </tr>
