<?php $__env->startSection('contenido'); ?>
	<div class="row">
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			...
			<?php echo Form::model($persona,['method'=>'PATCH','route'=>['compras.proveedor.update',$proveedor->idpersona]]); ?>
	...
	<div class="col-lg-6 col-sm-6 col-xs-12">
		...
		<div class="col-lg-6 col-sm-6 col-xs-12">
			<div class="form-group">
            	...
            	<input type="email" name="email" required value="<?php echo e(old('email')); ?>" class="form-control" placeholder="Email...">
            </div>
		</div>
